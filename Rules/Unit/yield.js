...
const getRules = (wonderRegistry = WonderRegistry_1.instance, playerResearchRegistry = PlayerResearchRegistry_1.instance) => [
    new Yield_1.default(new Priorities_1.Low(), new Criterion_1.default((unit, unitYield) => unitYield instanceof Yields_1.Movement), new Criterion_1.default((unit) => unit instanceof Types_1.Naval), new Criterion_1.default((unit) => wonderRegistry
        ...
        .some((wonder) => wonder.player() === unit.player())), new Criterion_1.default((unit) => !playerResearchRegistry.getByPlayer(unit.player()).completed(Advances_1.Magnetism)), new Effect_1.default((unit, unitYield) => unitYield.add(1))),
    new Yield_1.default(new Priorities_1.Low(), new Criterion_1.default((unit, unitYield) => unitYield instanceof Yields_1.Movement), new Criterion_1.default((unit) => unit instanceof Types_1.Naval), new Criterion_1.default((unit) => wonderRegistry
